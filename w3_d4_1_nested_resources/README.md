...
1. Now, to be double-sure, use Postman to check that the route is working.
 (or use `curl` from your terminal -- or all phrases, the curl command would be: `curl -X GET http://localhost:3000/phrases`)
...
You're ready to work on the challenges! Check out the solutions folder for examples of how the demo routes work.
